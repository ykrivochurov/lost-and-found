...
import ru.eastbanctech.board.web.config.jsonview.JsonViewSupportFactoryBean;
import ru.eastbanctech.board.web.config.jsonview.ViewAwareJsonMessageConverter;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"ru.eastbanctech.board.web.controllers"},
