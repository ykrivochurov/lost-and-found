...
@ComponentScan(basePackages = {"ru.poteriashki.laf.core.repositories", "ru.poteriashki.laf.core.repositories.impl"})
public class TestPersistenceJPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factoryBean.setPackagesToScan("ru.poteriashki.laf.core.model");
    ...
    public Map<String, Object> jpaProperties() {
        ...
        props.put("hibernate.ejb.naming_strategy", "ru.poteriashki.laf.core.dao.CustomNamingStrategy");
        props.put("hibernate.hbm2ddl.auto", "create-drop");
        return props;
    }
